use	damit
----------
if	object_id ( 'damit.DoSaveToXML' , 'p' )	is	null
	exec	( 'create	proc	damit.DoSaveToXML	as	select	ObjectNotCreated=	1/0' )
go
alter	proc	damit.DoSaveToXML	-- выгрузка данных с сервера
...
declare	@sMessage		varchar ( 256 )
	...
	,@sCharset		varchar ( 32 )=	'windows-1251'
----------
